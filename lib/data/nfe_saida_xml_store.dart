...
/// Armazena XML das NF-e de saida (modelo 55) para fechamento offline.
class NfeSaidaXmlStore {
  NfeSaidaXmlStore(this._storeDirectoryPath);

  final String _storeDirectoryPath;
  static const String _pasta = 'nfe_saida_xml';
